  ...
  def loadProjects(self, language):
    projects = {
      'en': [
        ...
        {
          'title': 'Roberto Cardenas Web Portfolio',
          'shortDescription': 'Web portfolio designed and implemented by me that you are currently using to check out my work!',
          'description': '',
          'description2': '',
          'languageIcons': ['flask.svg', 'html.svg', 'css.svg'],
          'thumbnail': 'homeSplash.png',
          'github': '',
          'website': ''
        },
      ]
